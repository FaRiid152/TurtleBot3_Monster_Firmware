...
// ===== Constants (as you requested in header) =====
...
public:
  ...
  bool update();                          // now calls FourWheelMotor::commandSides()
  void getRCdata(float* cmd_vel);

  void attachMotor(FourWheelMotor* drv) { motor_ = drv; }
